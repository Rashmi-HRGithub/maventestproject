...
public class WebDriverUtility {
	...
	//public void waitForElementInDOM(WebDriver driver) {
		//driver.manage().timeouts().implicitlyWait(IPathConstants.Implicitly_TIMEOUT.TimeUnit.SECONDS);
	//}
  
	/**
	 * wait for page to load before identifying any assynchronised[java scripts actions] element in DOM [HTML-Document]
	 * @param driver
	 */
